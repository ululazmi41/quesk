      ...
      <div className="m-auto sm:w-96">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <p>Don&apos;t have an account? <a href="#" className="text-blue-600 hover:underline hover:decoration-blue-400 hover:text-blue-400 transition transform">register</a></p>
          </div>
